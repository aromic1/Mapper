...
namespace UnitTests
{
    public class Tests
    {
        ...
        public static void Main()
        {
            ...
            Assert.That(false, Is.EqualTo(drawing.MainShape.IsGeometryShape));
            ...
            Assert.That(false, Is.EqualTo(newDrawing.MainShape.IsGeometryShape)); // IShape does not have set method so it's expected for this property to be set to it's default value - false
            ...
            Assert.That(false, Is.EqualTo(drawingDestination.MainShape.IsGeometryShape));
