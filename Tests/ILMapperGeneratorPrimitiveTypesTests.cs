...
public class ILMapperGeneratorPrimitiveTypesTests
{
    ...
    public void test_from_Int32_to_Int16(System.Int32 from, System.Int16 expectedTo)
    {
        ...
        var mapper = ilMapper.GetMapper<System.Int32, System.Int16>();
    ...
    {
        var ilMapper = new ILMapper();
        var mapper = ilMapper.GetMapper<System.Int64, System.Int16>();
        Assert.That(expectedTo, Is.EqualTo(mapper(from)));
    }
    ...
    {
        var ilMapper = new ILMapper();
        var mapper = ilMapper.GetMapper<System.Int64, System.Int32>();
        Assert.That(expectedTo, Is.EqualTo(mapper(from)));
    }
    ...
    {
        var ilMapper = new ILMapper();
        var mapper = ilMapper.GetMapper<System.Int16, System.Int64>();
        Assert.That(expectedTo, Is.EqualTo(mapper(from)));
    }
    ...
    {
        var ilMapper = new ILMapper();
        var mapper = ilMapper.GetMapper<System.Int32, System.Int64>();
        Assert.That(expectedTo, Is.EqualTo(mapper(from)));
    }
    ...
    {
        var ilMapper = new ILMapper();
        var mapper = ilMapper.GetMapper<System.UInt32, System.UInt16>();
        Assert.That(expectedTo, Is.EqualTo(mapper(from)));
    }
    ...
    {
        var ilMapper = new ILMapper();
        var mapper = ilMapper.GetMapper<System.UInt64, System.UInt16>();
        Assert.That(expectedTo, Is.EqualTo(mapper(from)));
    }
    ...
    {
        var ilMapper = new ILMapper();
        var mapper = ilMapper.GetMapper<System.UInt64, System.UInt32>();
        Assert.That(expectedTo, Is.EqualTo(mapper(from)));
    }
    ...
    {
        var ilMapper = new ILMapper();
        var mapper = ilMapper.GetMapper<System.UInt16, System.UInt64>();
        Assert.That(expectedTo, Is.EqualTo(mapper(from)));
    }
    ...
    {
        var ilMapper = new ILMapper();
        var mapper = ilMapper.GetMapper<System.UInt32, System.UInt64>();
        Assert.That(expectedTo, Is.EqualTo(mapper(from)));
    }
    ...
    {
        var ilMapper = new ILMapper();
        var mapper = ilMapper.GetMapper<System.Int16, System.UInt16>();
        Assert.That(expectedTo, Is.EqualTo(mapper(from)));
    }
    ...
    {
        var ilMapper = new ILMapper();
        var mapper = ilMapper.GetMapper<System.UInt16, System.Int16>();
        Assert.That(expectedTo, Is.EqualTo(mapper(from)));
    }
    ...
    {
        var ilMapper = new ILMapper();
        var mapper = ilMapper.GetMapper<System.Int32, System.UInt16>();
        Assert.That(expectedTo, Is.EqualTo(mapper(from)));
    }
    ...
    {
        var ilMapper = new ILMapper();
        var mapper = ilMapper.GetMapper<System.Int64, System.UInt16>();
        Assert.That(expectedTo, Is.EqualTo(mapper(from)));
    }
    ...
    {
        var ilMapper = new ILMapper();
        var mapper = ilMapper.GetMapper<System.Int64, System.UInt32>();
        Assert.That(expectedTo, Is.EqualTo(mapper(from)));
    }
    ...
    {
        var ilMapper = new ILMapper();
        var mapper = ilMapper.GetMapper<System.UInt32, System.Int16>();
        Assert.That(expectedTo, Is.EqualTo(mapper(from)));
    }
    ...
    {
        var ilMapper = new ILMapper();
        var mapper = ilMapper.GetMapper<System.UInt64, System.Int16>();
        Assert.That(expectedTo, Is.EqualTo(mapper(from)));
    }
    ...
    {
        var ilMapper = new ILMapper();
        var mapper = ilMapper.GetMapper<System.UInt64, System.Int32>();
        Assert.That(expectedTo, Is.EqualTo(mapper(from)));
    }
    ...
    {
        var ilMapper = new ILMapper();
        var mapper = ilMapper.GetMapper<System.Int16, System.UInt64>();
        Assert.That(expectedTo, Is.EqualTo(mapper(from)));
    }
    ...
    {
        var ilMapper = new ILMapper();
        var mapper = ilMapper.GetMapper<System.Int32, System.UInt64>();
        Assert.That(expectedTo, Is.EqualTo(mapper(from)));
    }
    ...
    {
        var ilMapper = new ILMapper();
        var mapper = ilMapper.GetMapper<System.UInt16, System.Int64>();
        Assert.That(expectedTo, Is.EqualTo(mapper(from)));
    }
    ...
    {
        var ilMapper = new ILMapper();
        var mapper = ilMapper.GetMapper<System.UInt32, System.Int64>();
        Assert.That(expectedTo, Is.EqualTo(mapper(from)));
    }
}
